...
const Hero: React.FC = () => {
  return (
    <div className="w-full h-[500px] md:h-[700px] relative flex justify-center items-center -mt-20 md:-mt-24 mb-0 overflow-hidden">
      ...
      <div className="w-full h-full relative">
        ...
        {/* Bottom Fade */}
        <div className="absolute inset-x-0 bottom-0 h-32 md:h-48 bg-gradient-to-t from-black via-black/80 to-transparent z-10 pointer-events-none"></div>
        {/* Left Fade */}
